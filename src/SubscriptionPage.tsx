...
import { createCheckoutSession, createCustomerPortalSession } from 'wasp/client/operations';
import { Button } from './client/components/ui/button';
import { Card, CardHeader, CardTitle, CardContent, CardDescription, CardFooter } from './client/components/ui/card';
      ...
      <div className='max-w-md mx-auto'>
        <Card className={cn(isSubscribed ? 'border-2 border-primary' : '')}>
          <CardHeader>
            ...
            <CardDescription>Access all features.</CardDescription> {/* Simple description */}
          </CardHeader>
        ...
        {user && (
           <p className="text-center text-sm text-muted-foreground mt-4">
             ...
             {user.subscriptionStatus === 'canceled' && ' (Expires end of period)'}
           </p>
        )}
